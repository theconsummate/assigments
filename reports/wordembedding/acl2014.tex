...
\maketitle
\begin{abstract}
This report is a critical response to the paper \cite{huang2015translation} presented by me in class. The report will first describe the contents of the paper briefly and then go into talking about the potential flaws and methodological errors I noticed. After that, I will do a comparison with \cite{faruqui2014improving} as the authors have used it as a baseline for their results.
\end{abstract}
...
Both of these papers share the same motivation of using the translation context to improve word embeddings.
